...
class Audio:
    ...
    def _griffin_lim(self, S, n_iter=30, momentum=0.99):
        """Faster Griffin-Lim algorithm with momentum"""
        ...
        for i in range(n_iter):
            ...
            # Apply momentum if we have previous angles
            if prev_angles is not None:
                angles = angles * momentum + prev_angles * (1 - momentum)
...
def inv_mel_spectrogram(mel_spectrogram, hparams):
    ...
    # Create an Audio instance with the hparams
    audio_obj = Audio(
    ...
    return audio_obj.inv_mel_spectrogram(mel_spectrogram)
